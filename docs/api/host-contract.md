...
4. Recover journal/locks/artifact associations, mark interrupted started attempts unknown and establish a new revision epoch where ownership/recovery/migration requires it. Only then return the wallet handle. No account import, sync or broadcast occurs on open.
