...
Current next step: PR/CI/merge accepted partial runtime experiment, then stop at genuine foreground generator-installation approval blocker. No bypass or runtime pass. All #2–#9 issue gates remain unpassed; next technical work after approval is genuine binding generation, raw/transformed artifact inspection and actual Node worker execution, followed by browser/scanner/threading/durability qualification.
