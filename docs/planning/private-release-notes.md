...
This is a private implementation checkpoint at qualified SDK source `29aee5560f17c9c36ab3957d5519cb294fc47223` (integrated by PR #114), not v1 acceptance or a publication announcement. The owner authorized local distribution qualification for [#8](https://github.com/jp4g/zcash.js/issues/8) and [#9](https://github.com/jp4g/zcash.js/issues/9); `private: true` remains intentional. Publication, deployment and license selection are not authorized by these results.
