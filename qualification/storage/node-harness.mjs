...
export function start(root, create = false) {
    const worker = new Worker(new URL('./node-worker.mjs', import.meta.url), { workerData: { root, create, bundle: process.env.STORAGE_BUNDLE } });
