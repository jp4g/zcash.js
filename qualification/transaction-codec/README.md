...
The independent R1–R3 fixes reject lossy serialization, unchecked JS narrowing and incomplete/false source provenance. Fresh coordinator Node and Firefox passed 13 vectors/208 adapter calls on the fixed bundle, and independent HIGH R2 accepted the bounded slice. See REPORT.md's coordinator acceptance update; historical worker CLIresult retains the original pending checkpoint and exact commands.
