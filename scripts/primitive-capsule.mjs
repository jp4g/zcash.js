...
const profiles=[
  {name:'primitive',receipt:'4086f21897f18ec0fb3d340930520f629431e8123084ceff1eb656808f8ca61d',directory:'primitive',receiptFile:'build.json',artifacts:'primitiveArtifacts',wasm:'bindings_bg.wasm',modules:['bindings.js','bytes.mjs','network.mjs','transaction.mjs']},
...
let codec;
export function initialize(){return codec??=${profile.factory}(Uint8Array.from(atob('${wasm.toString('base64')}'),c=>c.charCodeAt(0)));}`:`import {initialize as initializeNative,consensusContext,openViewingAuthority,decodeViewingAddress,selectViewingReceiver,validateBirthday} from '${join(source,'network.mjs')}';
...
export {consensusContext,decodeTransaction,openViewingAuthority,decodeViewingAddress,selectViewingReceiver,validateBirthday};`;
