...
export const walletProfile = {
  ...
  schemas: {
    operations: { walletViews: '5', walletSigner: '2', walletProposals: '2', walletPczt: '2', walletScan: '1', walletSync: '2', walletEnhancement: '1', walletQueries: '2', consensusContext: '1', decodeTransaction: '1' },
