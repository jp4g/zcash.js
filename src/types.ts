/** Shared SDK contracts. Runtime exports and function signatures are owned by index.ts
 * and their implementation modules. Types alone do not establish backend support.
 */
