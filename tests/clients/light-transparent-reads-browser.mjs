...
async function runFirefox() {
  ...
  const logs = process.env.LIGHT_TRANSPARENT_LOGS ?? outputRoot + '/light-transparent-reads-browser/logs';
  const scratch = process.env.LIGHT_TRANSPARENT_SCRATCH ?? outputRoot + '/light-transparent-reads-browser/scratch';
