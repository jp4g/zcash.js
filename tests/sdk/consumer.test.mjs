...
const implemented = ['accountFromViewingKey', 'accountIndex', 'addresses', 'blockHash', 'createLightClient', 'createPublicClient', 'defineNetwork', 'diversifierIndex', 'formatZec', 'grpc', 'http', 'isZcashError', 'parseZec', 'txId', 'viewing'];
