...
test('no-eager gate restores globals and detects even swallowed accesses', async () => {
  ...
  const valid = { ok: true, light:[{methods:11,cancelled:2,broadcastUnknown:1},{methods:11,cancelled:2,broadcastUnknown:1}], claims, eager: counts, precision: '9007199254740993', utf8: '€雪😀', negativeEager: 1, network: { modules: 2, instances: 2, fetches: 0, workers: 0, descriptors: 2, cancelled: 4 } };
